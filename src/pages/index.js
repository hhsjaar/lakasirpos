...
import { About, Benefits, Features, Footer, Hero, Navbar, Subscribe } from "@/components";
...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen overflow-hidden bg-white-custom dark:bg-black-custom">
        <main>
          {/* Navbar */}
          <Navbar />
